# Vectors SDK Overview

The `@frontal-labs/vectors` package provides a TypeScript/JavaScript client for Frontal's Vector embeddings, similarity search, and indexes.

## Installation

```bash
bun add @frontal-labs/vectors
# or
npm install @frontal-labs/vectors
```
...
const client = createVectorsClient({
...
const client = createVectorsClient(frontal);
```
...
The Vectors SDK throws typed errors from `@frontal-labs/core`:
...
- [@frontal-labs/ai](../ai/docs/OVERVIEW.md)
