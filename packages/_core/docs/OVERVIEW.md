# @frontal-labs/_core Overview

## Architecture Overview

The `@frontal-labs/_core` package is built around a modular architecture that provides a solid foundation for interacting with the Frontal platform APIs.
...
```typescript
import { clientConfigSchema, type ClientConfigInput } from '@frontal-labs/_core'
...
```typescript
import { createPageResult, type PageResult } from '@frontal-labs/_core'
...
```typescript
import { keys } from '@frontal-labs/_core'
