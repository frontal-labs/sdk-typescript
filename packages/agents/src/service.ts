...
export class AgentsService {
  ...
  get escalations(): EscalationsNamespace {
    return new EscalationsNamespace(this.http);
  }
}
...
export class AgentAccessor {
  ...
  async escalations(
    ...
    return createPageResult(
      asPagePayload<S.Escalation>(raw),
      (cursor: string) => this.escalations({ ...opts, cursor })
    );
  }
  ...
  get experiments(): ExperimentsAccessor {
    return new ExperimentsAccessor(this.id, this.http);
  }
