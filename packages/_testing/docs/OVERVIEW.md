...
```typescript
import { createMockConfig } from '@frontal-labs/_testing';
...
```typescript
import { setupTestEnvironment, cleanupTestEnvironment } from '@frontal-labs/_testing';
...
// tests/setup.js
const { setupTestEnvironment } = require('@frontal-labs/_testing');

setupTestEnvironment();

// Mock modules
jest.mock('@frontal-labs/_core', () => ({
...
```typescript
import { createMockConfig, setupTestEnvironment } from '@frontal-labs/_testing';
...
```typescript
import { setupTestEnvironment, cleanupTestEnvironment } from '@frontal-labs/_testing';
import { ai, blob } from '@frontal-labs/_core';
