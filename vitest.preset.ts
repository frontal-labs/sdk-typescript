...
export const resolveAliases: Record<string, string> = {
  ...
  "@frontal-labs/flags": resolve(packagesDir, "flags/src"),
  "@frontal-labs/functions": resolve(packagesDir, "functions/src"),
  ...
  "@frontal-labs/organization": resolve(packagesDir, "organization/src"),
  ...
  "@frontal-labs/vectors": resolve(packagesDir, "vectors/src"),
